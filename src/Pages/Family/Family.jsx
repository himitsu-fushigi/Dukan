 ...
 * @utils Utility tools
 */
import FamilyItems from "../../Utils/Home/Family.json";
...
export default function Family() {
  return (
    <div className="family__container">
      {/* section => toppicks */}
      <div className="family__topPicks">
        <div className="family__topPicks__title">
          <h3>Today's Top Picks</h3>

          <div className="family__topPicks__title__filters">
            <ProductFilters />
        ...
        <div className="family__topPicks__items">
